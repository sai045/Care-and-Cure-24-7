...
def heart_pred(input_parameters: heart_model_input):
    ...
    input_list = [age, sex, chest, bp, chol,
                  fbs, ekg, hr, excer, std, slp, nvf, tha]
...
def usHospitalAPI(input_parameters: usHospitalModelInput):
    ...
    us_hospitals = us_hospitals.drop(labels=['OBJECTID', 'ID', 'ZIP', 'ZIP4', 'TELEPHONE', 'STATUS', 'POPULATION', 'COUNTY', 'COUNTYFIPS', 'COUNTRY', 'NAICS_CODE',
                                     'NAICS_DESC', 'SOURCE', 'SOURCEDATE', 'VAL_METHOD', 'VAL_DATE', 'STATE_ID', 'ALT_NAME', 'ST_FIPS', 'OWNER', 'TTL_STAFF', 'BEDS', 'TRAUMA', 'HELIPAD'], axis=1)
    all_dist = {}
